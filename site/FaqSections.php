...
require 'config.php';
$i=0;
    $query = "SELECT * FROM `faq_sections` ORDER BY ".$config_FaqCathOrderBy.";";
  ...
  <body>
    ...
    <div class="row">
        ...
        <div class="small-3 medium-4 large-4 columns">
            <a href="FaqContent.php?id=<?PHP echo $data[$i]['pk'];?>">
            <div class="panel">
                <table width="100%" style="background-color:<?PHP echo $data[$i]['bg'];?>;-webkit-box-shadow: 10px 10px 5px 0px rgba(0,0,0,0.41);-moz-box-shadow: 10px 10px 5px 0px rgba(0,0,0,0.41);box-shadow: 10px 10px 5px 0px rgba(0,0,0,0.41);">
                    <tr>
