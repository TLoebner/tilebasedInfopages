...
if ($_SESSION['rights'] == "admin"){
    if (isset($_GET['pk']) && is_numeric($_GET['pk'])){
        $pk=$_GET['pk'];
        $query="SELECT * FROM `help_subsections` WHERE pk=".$pk;
...
<?PHP
            ...
            echo "<tr><td colspan=\"2\" align=center><a href=\"index.php?action=DeleteHelpSubcath&pk=".$pk."\">Rubrik löschen</a></td></tr>\n";
        }
    }
}
?>
