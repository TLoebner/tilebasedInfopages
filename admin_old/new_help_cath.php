...
<form enctype="multipart/form-data" name="new_help_cath" method="POST" action="new_help_cath.php">
<table>
<tr>
<td>&nbsp;</td><td>Name</td><td>Vordergrund</td><td>Hintergrund</td><td>Bild</td>
</tr>
<?PHP
for ($x=0;$x<2;$x++) {
    echo "\t<tr>\n";
