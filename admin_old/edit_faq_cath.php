...
<td valign="top">
<div style="width:250 px;height:100%;overflow-y: auto;overflow-x: auto;">
<form enctype="multipart/form-data" name="edit_faq_cath" method="POST" action="edit_faq_cath.php">
<table>
<tr>
...
foreach ($dataTblFaqSections as $key1 => $value1) {
    if (is_numeric($key1)){
        ...
        echo "<td align=center><input type=\"hiden\" value=\"9999\" size=5 name=\"in_".$key1."_reihe\" value=\"".(string)$value1['sequence_no']."\"></td>\n";
